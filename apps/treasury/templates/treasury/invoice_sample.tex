...
\newcommand	{\ListeProduits}{
    {% for product in products %}
        {{ product.designation|escape_tex }}    &    {{ product.amount_euros|escape_tex|floatformat:2 }}    &    {{ product.quantity|escape_tex|floatformat:2 }}    &    {{ product.total_euros|escape_tex|floatformat:2 }}   \cr
    {% endfor %}
}
...
{% for product in products %}
\AjouterProduit{{"{"}}{{ product.designation|escape_tex }}} {{"{"}}{{ product.quantity|escape_tex }}} {{"{"}}{{ product.amount_euros|escape_tex }}} {{"{"}}{{ product.total_euros|escape_tex }}}
{% endfor %}
